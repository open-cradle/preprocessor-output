...
#ifdef REQUESTS_META_INFO_QUERY 
    #undef REQUESTS_META_INFO_QUERY 
#endif 
...
#ifdef REQUESTS_META_INFO_RESPONSE 
    #undef REQUESTS_META_INFO_RESPONSE 
#endif 
...
#line 1 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
#ifndef CRADLE_WEBSOCKET_MESSAGES_HPP
#define CRADLE_WEBSOCKET_MESSAGES_HPP

#line 4 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 9 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
namespace cradle {

#line 11 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 18 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 24 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 31 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 38 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
    ...
    #undef JSON 
#endif 
#line 45 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
enum class output_data_encoding { YAML,DIAGNOSTIC_YAML,MSGPACK,JSON }; template<> struct definitive_type_info_query<output_data_encoding> {     static void     get(cradle::api_type_info*); }; template<> struct type_info_query<output_data_encoding> {     static void     get(cradle::api_type_info*); }; template<> struct enum_type_info_query<output_data_encoding> {     static void     get(cradle::api_enum_info*); }; static inline size_t deep_sizeof(output_data_encoding) { return sizeof(output_data_encoding); } inline size_t hash_value(output_data_encoding const& x) {     return size_t(x); }static inline unsigned get_value_count(output_data_encoding) { return 4; } char const* get_value_id(output_data_encoding value); void to_dynamic(     cradle::dynamic* v,     output_data_encoding x); void from_dynamic(     output_data_encoding* x,     cradle::dynamic const& v); std::ostream& operator<<(     std::ostream& s,      output_data_encoding const& x); 
    ...
    #undef JSON 
#endif 
#line 59 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 70 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 79 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 85 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 93 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 99 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 106 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 112 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 121 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 127 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 135 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 143 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 150 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 156 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 164 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 170 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 177 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 183 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 190 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 196 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 205 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 220 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
typedef std::vector<cradle::object_node_diff> object_tree_diff;

#line 222 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
typedef cradle::object_tree_diff calculation_diff_response;

#line 224 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 233 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
typedef cradle::object_tree_diff iss_diff_response;

#line 235 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 244 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 250 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
    ...
    #undef CLEAR_ADMIN 
#endif 
#line 256 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 263 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 269 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 312 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
    ...
    #undef UNKNOWN 
#endif 
#line 319 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 329 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 337 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 347 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
...
#line 354 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
} namespace cradle { struct requests_meta_info_response { std::string git_version;  requests_meta_info_response() {} explicit requests_meta_info_response(std::string const& git_version) : git_version(git_version) {} };  inline requests_meta_info_response make_requests_meta_info_response(  std::string git_version ) { return requests_meta_info_response(  std::move(git_version) ); }template<> struct definitive_type_info_query<requests_meta_info_response> {     static void     get(cradle::api_type_info*); }; template<> struct type_info_query<requests_meta_info_response> {     static void     get(cradle::api_type_info*); }; template<> struct structure_field_type_info_adder<requests_meta_info_response> {     static void     add(std::map<std::string, cradle::api_structure_field_info>*); }; bool operator==(requests_meta_info_response const& a, requests_meta_info_response const& b); bool operator!=(requests_meta_info_response const& a, requests_meta_info_response const& b); bool operator<(requests_meta_info_response const& a, requests_meta_info_response const& b); void swap(requests_meta_info_response& a, requests_meta_info_response& b); size_t deep_sizeof(requests_meta_info_response const& x); void write_fields_to_record(cradle::dynamic_map& record, requests_meta_info_response const& x); void to_dynamic(cradle::dynamic* v, requests_meta_info_response const& x); void read_fields_from_record(requests_meta_info_response& x, cradle::dynamic_map const& record); void from_dynamic(requests_meta_info_response* x, cradle::dynamic const& v); std::ostream& operator<<(std::ostream& s, requests_meta_info_response const& x);std::ostream& operator<<(std::ostream& s, requests_meta_info_response const& x);size_t hash_value(requests_meta_info_response const& x);} namespace cradle { 
...
#line 398 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
} // namespace cradle

#line 400 "C:/dev/open-cradle/cradle/src/cradle/websocket/messages.hpp"
#endif
